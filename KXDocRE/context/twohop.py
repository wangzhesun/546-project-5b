...
def batch_sparql_query(entity_pairs):
    ...
    # print(values_clause)
    # query = f"""
    # SELECT ?entity1 ?relation1 ?x ?relation2 ?y ?relation3 ?entity2
    # WHERE {{
...
output_file = "full_threehop_latest.txt"       # Replace with your output file
